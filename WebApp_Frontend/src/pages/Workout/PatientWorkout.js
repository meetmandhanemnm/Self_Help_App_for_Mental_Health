...
const PatientWorkout = (props) => {
  ...
  const Fetch_data = async () => {
    try {
      const response = await fetch(
        ` https://4ae2-103-156-19-229.ngrok-free.app/patient/workout/${patient_id}`
      );
  ...
  const Fetch_data2 = async () => {
    try {
      const response = await fetch(
        ` https://4ae2-103-156-19-229.ngrok-free.app/doctor/workout/${patient_id}`
      );
      const data = await response.json();
      setNonTaskList(data);
      console.log(data);
  ...
  const handleAdd = async () =>{
    try{
      ...
      const response =await  fetch(`https://4ae2-103-156-19-229.ngrok-free.app/doctor/workout/${patient_id}/${pre_id}`, {
