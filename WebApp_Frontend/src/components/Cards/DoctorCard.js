...
const DoctorCard = ({taskObj, index}) => {
    ...
    const handleResponse= ()=>{
        navigate('/patient_details/patient_workout/workout_responses',{state: {workout_instance_id:taskObj.workout_instance_id}})
        ...
        <div className = "doctor-card-wrapper mr-5">
            ...
            <div className = "task-holder">
                ...
                <div style={{position: "absolute", right : "20px", bottom : "20px"}}>
                   ...
                   <button className='btn btn-primary' style={{}} onClick={handleResponse}>Show Responses</button>
